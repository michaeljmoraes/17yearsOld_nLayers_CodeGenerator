...
{
	/// <summary>
	/// Summary description for B_PROJTOEO
	/// </summary>
	public class B_PROJTOEO : AEntityObject
	{
		...
		{
			IMapper mapper = (IMapper) CacheManager.GetValue("B_PROJTOEO", "Mapper");
			if(mapper == null)
			{
				mapper = new B_PROJTOMapper(this.GetType());
				CacheManager.SetValue("B_PROJTOEO", "Mapper", mapper, -1);
			}
			return mapper;
		} 
